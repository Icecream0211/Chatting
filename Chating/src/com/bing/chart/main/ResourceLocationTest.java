...
public class ResourceLocationTest {
	...
	public static void fileSytemType() {
		...
		//URL fileURL=this.getClass().getResource("/resource/a.txt");
		//System.out.println(this.class.getResource("").toURI().getPath());
	...
	public void abc(){
		//this.getClass().getClassLoader().getResource(arg0)
	}
